...
QT_MOC_LITERAL(3, 36, 5), // "start"
QT_MOC_LITERAL(4, 42, 3), // "end"
QT_MOC_LITERAL(5, 46, 5), // "pause"
QT_MOC_LITERAL(6, 52, 6), // "update"
QT_MOC_LITERAL(7, 59, 7) // "cleanup"

    },
    "Engine::AudioListener\0signalThread\0\0"
    "start\0end\0pause\0update\0cleanup"
};
...
void Engine::AudioListener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AudioListener *_t = static_cast<AudioListener *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject Engine::AudioListener::staticMetaObject = {
    { &Engine::Listener::staticMetaObject, qt_meta_stringdata_Engine__AudioListener.data,
      qt_meta_data_Engine__AudioListener,  qt_static_metacall, nullptr, nullptr}
};
