...
QT_MOC_LITERAL(7, 59, 6) // "update"
    ...
    "\0start\0end\0pause\0run\0update"
};
...
void Engine::KeyboardListener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        KeyboardListener *_t = static_cast<KeyboardListener *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (KeyboardListener::*_t)();
...
const QMetaObject Engine::KeyboardListener::staticMetaObject = {
    { &Listener::staticMetaObject, qt_meta_stringdata_Engine__KeyboardListener.data,
      qt_meta_data_Engine__KeyboardListener,  qt_static_metacall, nullptr, nullptr}
};
