...
QT_INIT_METAOBJECT const QMetaObject Engine::Listener::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Engine__Listener.data,
    qt_meta_data_Engine__Listener,
    qt_static_metacall,
    nullptr,
    nullptr
} };
