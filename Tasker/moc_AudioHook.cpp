...
void Engine::AudioHook::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AudioHook *_t = static_cast<AudioHook *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject Engine::AudioHook::staticMetaObject = {
    { &Engine::Hook::staticMetaObject, qt_meta_stringdata_Engine__AudioHook.data,
      qt_meta_data_Engine__AudioHook,  qt_static_metacall, nullptr, nullptr}
};
